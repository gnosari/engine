...
gnosari worker start --queue high_priority

# Start with debug logging
gnosari worker start --loglevel debug
```
...
gnosari worker restart --concurrency 8 --loglevel debug
```
...
gnosari flower --auth myuser:mypassword

# Start with custom broker URL
gnosari flower --broker redis://localhost:6379/1
```
...
gnosari worker start --loglevel debug --concurrency 2

# 3. In another terminal, start Flower
gnosari flower

# 4. Run your team with async tools
gnosari --config examples/async_team.yaml --message "Process files"
```
...
gnosari worker start --concurrency 8 --queue high_priority &
gnosari worker start --concurrency 4 --queue low_priority &
...
gnosari worker restart --concurrency 4
...
gnosari worker start --loglevel debug --concurrency 1
...
gnosari worker start --concurrency 2   # Light load
gnosari worker start --concurrency 4   # Medium load
gnosari worker start --concurrency 8   # Heavy load
```
...
gnosari worker start --queue critical --concurrency 2
gnosari worker start --queue normal --concurrency 4
gnosari worker start --queue background --concurrency 1
```

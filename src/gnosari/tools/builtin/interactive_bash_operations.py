...
class InteractiveBashOperationsTool(SyncTool):
    ...
    def __init__(self, 
                 ...
                 tool_name: str = "interactive_bash",
                 tool_description: str = "Execute interactive bash commands and respond to prompts"):
    ...
    async def _action_start_session(self, parsed_args: InteractiveBashArgs) -> str:
        ...
        try:
            ...
            initial_output = await self._read_available_output(session)
    ...
    async def _action_check_session(self, parsed_args: InteractiveBashArgs) -> str:
        ...
        # Read any available output and update session state
        await self._read_available_output(session)
    ...
    async def _read_available_output(self, session: InteractiveSession) -> str:

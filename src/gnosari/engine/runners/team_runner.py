...
@dataclass
class TeamContext:
    """Context object containing team execution data."""
    original_config: Dict[str, Any]
    team: Optional[Any] = None  # Team object reference
...
class TeamRunner(BaseRunner):
    ...
    async def run_team_async(self, message: str, debug: bool = False, 
        ...
        try:
            ...
            # Create context with original config, team reference, and session data
            context = TeamContext(

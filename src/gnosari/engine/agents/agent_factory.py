...
class AgentFactory:
    ...
    def create_agent(
        ...
        try:
            ...
            agent_temperature = self._get_agent_temperature(agent_config)
    ...
    def _get_agent_temperature(self, agent_config: Dict[str, Any]) -> float:
        """Get temperature for agent, with fallback to default."""
        if agent_config:
    ...
    def _build_system_prompt(
        ...
        if is_orchestrator:
            prompt_components = build_orchestrator_system_prompt(
                name, instructions, team_config, agent_tools, 
